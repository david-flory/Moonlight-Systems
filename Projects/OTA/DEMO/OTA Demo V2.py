...
ver = 'V3' #increment ver on each updated file
...
You are now running 'OTA Demo'
OTA Demo has been updated.   THIS IS VERSION 2

The next test demonstrates downloading an update that has a flaw and crashes at runtime.
Main will revert to a backup and restart the program.

Run 'Split_files.py' on 'OTA Demo V3' to prepare the chunks. Use the filenme 'program.py'
