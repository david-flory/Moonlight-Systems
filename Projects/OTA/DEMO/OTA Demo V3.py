...
import ubinascii
"""DELIBERATE ERROR import network has been removed"""
...
ver = 'V4' #increment ver on each updated file
...
For the purposes of this demo, we shall call this 'OTA Demo', and it is version 3.
This version has a deliberate error so that it crashes at runtime to demonstrate
the backup system."""
    print(text + '\n\n')
