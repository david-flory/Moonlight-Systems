RMM.py is a micropython class module for the ESP32 to facilitate easy saving of variables to RTC memory, and restoring them when a program wakes from deepsleep.
